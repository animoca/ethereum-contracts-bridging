...
describe('FxERC20FixedSupplyChildTunnel', function () {
  ...
  const fixture = async function () {
    ...
    this.unmappedTokenToZeroAddress = await deployContract('FxERC20FixedSupplyMock', forwarderRegistryAddress);
    ...
    this.unmappedTokenToWrongAddress = await deployContract('FxERC20FixedSupplyMock', forwarderRegistryAddress);
